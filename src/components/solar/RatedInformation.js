    ...
    <div className="mb-3 bg-white p-3">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 flex-wrap text-center">
        <div className="bg-gray-200 p-2 rounded">
          <h3 className="text-xs">Nominal AC Voltage</h3>
        ...
        <div className="bg-gray-200 p-2 rounded">
          <h3 className="text-xs">Nominal AC Current</h3>
          <p className="text-2xl">
        ...
        <div className="bg-gray-200 p-2 rounded">
          <h3 className="text-xs">Rated Battery Voltage</h3>
          <p className="text-2xl">
        ...
        <div className="bg-gray-200 p-2 rounded">
          <h3 className="text-xs">Nominal Output Voltage</h3>
          <p className="text-2xl">
        ...
        <div className="bg-gray-200 p-2 rounded">
          <h3 className="text-xs">Nominal Output Frequency</h3>
          <p className="text-2xl">
        ...
        <div className="bg-gray-200 p-2 rounded">
          <h3 className="text-xs">Nominal Output Current</h3>
          <p className="text-2xl">
        ...
        {/*  */}
        <div className="bg-gray-200 p-2 rounded">
          <h3 className="text-xs">Nominal Output Apparent Power</h3>
          <p className="text-2xl">
        ...
        <div className="bg-gray-200 p-2 rounded">
          <h3 className="text-xs">Nominal Output Active Power</h3>
          <p className="text-2xl">
